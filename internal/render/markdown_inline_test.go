...
func TestParseMarkdownInline(t *testing.T) {
	cases := []struct {
		...
		{"deep nesting cumulative styles", "**a _b ~~c~~ d_ e**",
			`[{"type":"text","text":"a ","style":{"bold":true}},{"type":"text","text":"b ","style":{"bold":true,"italic":true}},{"type":"text","text":"c","style":{"bold":true,"italic":true,"strike":true}},{"type":"text","text":" d","style":{"bold":true,"italic":true}},{"type":"text","text":" e","style":{"bold":true}}]`},
		{"empty-url brackets stay literal", "see [label]() here",
			`[{"type":"text","text":"see [label]() here"}]`},
		{"bracket without paren stays literal", "a [not a link] b",
			`[{"type":"text","text":"a [not a link] b"}]`},
		{"link label keeps markers literal (v1)", "[**x**](https://y.com)",
			`[{"type":"link","url":"https://y.com","text":"**x**"}]`},
		{"empty", "",
			`[{"type":"text"}]`},
	}
