...
// nameByEmoji is keyed by the emoji with U+FE0F (variation selector-16)
// stripped; for duplicate emoji the last emojilib entry wins, matching how
// node-emoji builds its reverse map.
var nameByEmoji = map[string]string{
	"💯":       "100",
	"🔢":       "1234",
	"😀":       "grinning",
	"😬":       "grimacing",
